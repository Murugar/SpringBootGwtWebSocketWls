package com.iqmsoft.boot.ws.wls.ui;
...
import com.iqmsoft.boot.ws.wls.elemental.MessageEvent;
import com.iqmsoft.boot.ws.wls.elemental.WebSocket;
...
public class MainPage extends Composite {	
	...
	public MainPage() {
		...
		socket = new WebSocket("ws://localhost:7001/server/atom/gwidgets-ws");
